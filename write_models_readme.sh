...
cat > "$ROOT/models/analysis/README.md" << 'EOF'
# models/analysis/
...
echo "Wrote models/analysis/README.md"
echo ""
echo "Now run:"
echo "  git add models/analysis/README.md"
echo "  git commit -m 'Add README for models/analysis/ explaining JSON outputs'"
echo "  git push"

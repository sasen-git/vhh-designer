...
_override = os.environ.get("VERNIER_OVERRIDE")
if _override:
    VERNIER_POSITIONS = [int(x) for x in _override.split(",")]
...
"""
    ...
    ap.add_argument("--cluster-min-positions", type=int, default=12,
                    help="Minimum valid vernier positions for clustering (default: 12 of 16)")

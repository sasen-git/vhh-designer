...
def extract_frameworks(full_seq: str, cdr1: str, cdr2: str, cdr3: str) -> Tuple[str, str, str, str]:
    ...
    # Find CDR positions
    cdr1_start = full_seq.find(cdr1) if cdr1 else -1
    cdr2_start = full_seq.find(cdr2) if cdr2 else -1
    cdr3_start = full_seq.find(cdr3) if cdr3 else -1
        ...
        for i in inner_bar:
            ...
            if passes_threshold and region_identities:
                ...
                hit_data = {
                    ...
                    "full_identity": 0.0,  # Don't calculate unless needed
                    "cdr1_seq": db_cdr1,
                    "cdr1_identity": cdr1_id,
                    "cdr2_seq": db_cdr2,
                    "cdr2_identity": cdr2_id,
                    "cdr3_seq": db_cdr3,
                    "cdr3_identity": cdr3_id,
                    "target": target,
                    "patent_id": patent_id,
...
def export_to_excel(csv_path: str, results_csv_path: str, output_folder: str, 
                   query_cdrs: Dict = None, include_metadata: bool = True) -> Optional[str]:

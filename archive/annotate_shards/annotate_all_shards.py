...
# FR2 starts with W at IMGT 41, so:
...
def process_with_anarci(df: pd.DataFrame, batch_size: int = 2000) -> pd.DataFrame:
...
def process_all_shards(
    ...
    for shard_path in npz_files:
        df = process_shard(shard_path, use_anarci=use_anarci, batch_size=batch_size)
    ...
    core_cols = [
        ...
        'family', 'hallmarks', 'imgt_42', 'imgt_49', 'imgt_50', 'imgt_52',
